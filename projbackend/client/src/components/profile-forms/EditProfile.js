...
const EditProfile = ({ profile :{ profile , loading} ,
   ...
   useEffect(() => {
       ...
       setFormData({
        maritalstatus: loading || !profile.maritalstatus ? '' : profile.maritalstatus,   
        height: loading || !profile.height ? '' : profile.height,   
        familytype: loading || !profile.familytype ? '' : profile.familytype,   
        mothertongue: loading || !profile.mothertongue ? '' : profile.mothertongue,   
